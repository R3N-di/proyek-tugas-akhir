    ...
    <div class="container p-5">
        ...
        <form action="/login" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="nip" aria-describedby="helpId" placeholder="Masukan NIP...">
            </div>
            <div class="mb-3">
              <label for="password" class="form-label">Password</label>
              <input type="text" class="form-control" name="password" aria-describedby="helpId" placeholder="Masukan Password">
            </div>
            <button type="submit" name="login" value="guru" class="btn btn-primary">Login</button>
        </form>
    </div>
